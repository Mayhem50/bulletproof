...
5. Check existing encryption configuration: database-level encryption, TLS certificates, application-level field encryption (.github/copilot-instructions.md)
